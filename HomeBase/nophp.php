...
<div class="container">
    ...
    <script>
        ...
        let adminDel = document.querySelectorAll('.admin_del_btn');
        ...
        let no = document.querySelector('.no');
                ...
                confirmWindow.style.left = 600+ questionBlock.left - confirmWindow.clientWidth  + 20 + window.pageXOffset  + 'px';


        document.addEventListener('click', event => {
            console.log(event.composedPath())
            adminDel.forEach(item => {
